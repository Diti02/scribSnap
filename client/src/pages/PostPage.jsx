...
export const PostPage = () => {
  ...
  return (
    ...
    <h1 className="text-3xl mt-10 p-3 text-center font-serif max-w-2xl mx-auto lg:text-4xl">{post && post.title}
    </h1>
    ...
    <div className="flex justify-between p-3 border-b border-blue-500 mx-auto w-full max-w-2xl text-xs">
